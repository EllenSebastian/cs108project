...
<%
	...
	quizWebsite.User u = quizWebsite.UserManager.getUser(1);
	session.setAttribute(quizWebsite.Constants.session_currentUser, u); // TODO get loginServlet to set current user 
%>  
</ul>
</body>
</html>